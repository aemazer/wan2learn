...
function showHeaderLoggedIn($username){
	...
	$target = 'dummypage.php';
	echo '
		<div id = "logoDiv"><img src="images/wan2learnlogoNew.png"></div>
		<div id = "linksDiv">
			<p class="links">|<a href="dummypage.html">Contact</a>|<a href="dummypage.html">Help</a>|<a href="dummypage.html">Cancellations</a>|<a href="dummypage.html">FAQs</a>|<a href="dummypage.html">About</a>|link($target, $username)|</p>
		</div>';
}